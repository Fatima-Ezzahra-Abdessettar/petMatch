      ...
      <div 
        ...
        style={{
          backgroundColor: isScrolled 
            ? (isDarkMode ? 'rgba(54, 51, 46, 0.95)' : 'rgba(243, 240, 232, 0.95)')
            : (isDarkMode ? 'rgba(54, 51, 46, 0.5)' : 'rgba(146, 137, 124, 0.08)')
        }}
      >
        <Link to={"/"}><img src="public/pet-MattchBlack.PNG" alt="petMatch" className='w-30' /></Link>
        ...
        <div className='flex gap-4 items-center'>
          ...
          >
            {isDarkMode ? (
              <i className="ri-sun-line sm:text-lg text-md" style={{ color: '#F7F5EA' }}></i>
            ) : (
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          <div 
            ...
            `}
            style={{
              backgroundColor: isDarkMode ? 'rgba(54, 51, 46, 0.98)' : 'rgba(243, 240, 232, 0.98)'
            }}
          ...
          >
            ...
            <div 
              ...
              style={{
                borderColor: isDarkMode ? 'rgba(247, 245, 234, 0.2)' : 'rgba(0, 0, 0, 0.1)'
              }}
            >
              <img src="public/pet-MattchBlack.PNG" alt="petMatch" className='w-16' />
              <div className='flex gap-4 items-center'>
                <button 
                  onClick={closeMobileMenu}
                  ...
                  style={{
                    ...
                    backgroundColor: isDarkMode ? 'rgba(247, 245, 234, 0.1)' : 'rgba(0, 0, 0, 0.05)'
                  }}
                >
